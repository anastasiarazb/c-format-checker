...
//                              "Use «./c-format-checker --help» for explanation.";
    ...
    const std::string man =  // Аналогично русскояз. мануалу https://www.opennet.ru/man.shtml?topic=grep&category=1
        ...
        ".\n"
        "ОПЦИИ\n"
        "       -f, --file    Файл исходного текста программы на языке С (ключ~\\prog{-f} не требуется, если этот аргумент идет первым).\n"
        ...
        "       --help        Помощь.\n"
        "       -l, --logfile Имя файла для записи отладочной информации (по умолчанию: \\prog{c-format-checker.log}).\n"
        "СТАТУС ВЫХОДА\n       "
